...
var BUILDINGS = {
  ...
  refinery: { name:"Ore Refinery", cat:"building", cost:1500, time:20, w:3, h:2, hp:1300, armor:"structure",
    ...
    desc:"Processes raw ore into credits and ships with one Harvester. Also stores 2,500 credits. Each refinery past the first (three at most) imports 0.12 bbl/s of crude at 25 credits a barrel while you bank 5,000 and hold under 250 bbl. Fuel bought on the market (BUY FUEL, top bar) is unloaded here." },
...
Object.assign(UNITS, {
  ...
  cawacs_b: { /* radarGen: Crowsnest is Searchwater 2000 and Cerberus, the Sea King ASaC.7 fit of 2002 moved onto a Merlin. The aircraft is new; the radar is not. */ radarGen:"e00", from:"e20", fac:"gbr", role:"cawacs", name:"Crowsnest", full:"Merlin HM2 with Crowsnest AEW", cat:"aircraft",
...
/* -------- air -------- */
  ...
  cawacs_f: { /* radarGen: E-2C Hawkeye 2000 - the APS-145, delivered to the Aeronavale in 2003-04. France has never flown an E-2D. */ radarGen:"e00", fac:"fra", role:"cawacs", name:"E-2C Hawkeye", full:"Northrop Grumman E-2C Hawkeye 2000", cat:"aircraft",
...
Object.assign(UNITS, {
  ...
  awacs_r: { /* radarGen: E-2K is an E-2T brought up to Hawkeye 2000 standard: the same APS-145, not the E-2D's APY-9. */ radarGen:"e00", fac:"roc", role:"awacs", name:"E-2K Hawkeye", full:"Northrop E-2K Hawkeye 2000",
